...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🍿ʟᴀᴛᴇsᴛ ғɪʟᴍ ᴜᴘᴅᴀᴛᴇs🍿', url='https://t.me/+yYnf-ZsISX01NWY1')
            ],[
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@mkmovies_hub  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            InlineKeyboardButton('⚡10 ʟᴀᴋs+ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs ɢʀᴏᴜᴘ⚡', url='https://t.me/mkmovies_hub')
            ],[
            InlineKeyboardButton('🍿ʟᴇᴛᴇsᴛ ᴍᴏᴠɪᴇ ᴜᴘᴅᴀᴛᴇs 🍿', url='https://t.me/MKStreamingHub'),
            InlineKeyboardButton('👻ALL TELUGU ANIMIS&CARTOONS 👻', url='https://t.me/MkAnimewood')
            ],[
